...
def preprocess_info(info_dict, player=1):
    ...
    self_hitstun = self_recovery = opp_hitstun = opp_recovery = opp_crouch = opp_jump = opp_normal = opp_air_normal = opp_special = -1
    self_fireball_out = self_fireball_loc = opp_fireball_out = opp_fireball_loc = -1
    ...
    if opp_fireball_out == 1:
        ...
        opp_fireball_loc = (opp_fireball_loc - self_x)/210
    else:
        opp_fireball_out = -1
